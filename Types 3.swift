...
class Types3 : SKScene{
    var background = SKSpriteNode(imageNamed: "background")
    var button1 = Button(imageNamed: "final button")
    
    var image1 = SKSpriteNode(imageNamed: "three types")
    var image2 = SKSpriteNode(imageNamed: "03")
    ...
    override func sceneDidLoad() {
        ...
        let circ3 = SKCircle(pos: CGPoint(x: -100, y: 140))
        let circ4 = SKCircle(pos: CGPoint(x: 100, y: -140))
        
        self.pontos.append(circ1)
        self.pontos.append(circ3)
        self.pontos.append(circ4)
